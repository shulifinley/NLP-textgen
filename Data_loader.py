...
class Data_for_train(Vocab):
    def __init__(self, url_list,charecters = ['pumbaa', 'timon'],contain_non_embbedding = True):
        self.url_list= url_list
        self.charecters =charecters # Which charecters to train of.
        self.dict ={ }
        self.contain_non_embbedding =contain_non_embbedding
        super().__init__(name='lion',contain_non_embeddings= self.contain_non_embbedding)
